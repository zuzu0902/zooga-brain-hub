...
const AGENTS = [
  ...
  { key: "handoff_router", enabled: true, maturity: "partial", source: "pending_ai_insights + manager_attention_required", description: "Backend routing exists, dedicated UI console not yet built." },
  ...
  { key: "handoff_console_ui", enabled: false, maturity: "planned", source: "(planned)", description: "Future: dedicated UI to triage pending_ai_insights and escalations." },
];
