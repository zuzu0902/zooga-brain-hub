...
const AGENTS = [
  ...
  { key: "campaign_dispatcher", enabled: true, maturity: "live", source: "src/lib/campaign-send.server.ts + campaigns.functions.ts", description: "Sends selected leads to Tamar backend for outreach." },
