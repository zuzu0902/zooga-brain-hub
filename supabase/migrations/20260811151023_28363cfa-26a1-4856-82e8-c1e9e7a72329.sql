...
BEGIN
  ...
  IF p_reset_intake THEN
    ...
    UPDATE public.campaign_contacts
       SET conversion_stage = 'new', conversation_intent = NULL
    ...
    UPDATE public.contacts SET
      ...
      relationship_intake_status = 'not_offered',
